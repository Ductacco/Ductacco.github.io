...
Sau đó tôi đã dùng lệnh `enum4linux-ng -A <IP>` để sử dụng công cụ enum4linux là tổng hợp các công cụ quản trị mạng để quét bao gồm cả smbclient, rpcclient,nmblookup,....![alt text](image-6.png)
